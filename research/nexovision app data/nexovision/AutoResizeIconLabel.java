...
public class AutoResizeIconLabel extends IconLabel {
    ...
    public AutoResizeIconLabel(Context context) {
        super(context);
        this.mNeedsResize = false;
    ...
    public AutoResizeIconLabel(Context context, AttributeSet attributeset) {
