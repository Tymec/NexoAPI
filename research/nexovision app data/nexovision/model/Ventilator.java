...
public class Ventilator extends Switch {
    ...
    private static Integer _typeNameResId = Integer.valueOf(R.string.ResourceTypeName_Ventilator);
    ...
    private Integer SW_ACTION_TOGGLE = Integer.valueOf(2);
    ...
    public Drawable getBackground() {
        ...
        GradientDrawable gdr = (GradientDrawable) ContextCompat.getDrawable(MainActivity.getContext(), R.drawable.rounded_rectangle_green).mutate();
        gdr.setColor(interpolateRGB(ContextCompat.getColor(MainActivity.getContext(), R.color.gray), ContextCompat.getColor(MainActivity.getContext(), R.color.green), bri / 100.0f));
        GradientDrawable gdr_light = (GradientDrawable) ContextCompat.getDrawable(MainActivity.getContext(), R.drawable.rounded_rectangle_lightgreen).mutate();
        gdr_light.setColor(interpolateRGB(ContextCompat.getColor(MainActivity.getContext(), R.color.gray_light), ContextCompat.getColor(MainActivity.getContext(), R.color.green_light), bri / 100.0f));
